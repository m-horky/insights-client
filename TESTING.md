...
$ python3 scripts/integration-tests.py generate-settings > settings.toml
$ python3 scripts/integration-tests.py build-image
$ podman image ls -a
REPOSITORY                       TAG     IMAGE ID      CREATED         SIZE
localhost/insights-client-test   latest  9981e9c07636  30 seconds ago  461 MB
$ # Run the tests
$ python3 scripts/integration-tests.py run-tests --settings ./settings.toml
$ python3 scripts/integration-tests.py run-tests --settings ./settings.toml --egg ../insights-core/insights.zip
$ # Inspect the situation interactively
$ python3 scripts/integration-tests.py shell --settings ./settings.toml --egg ../insights-core/insights.zip
```
